...
(defun comment-edit-save-state  ()
  ...
  (define-key comment-edit-mode-map "\C-c\C-k" 'comment-edit-abort)
  (define-key comment-edit-mode-map "\C-x\C-s" 'comment-edit-save)
...
(defun comment-edit-save ()
  (interactive)
  (let(total-lines
       (comment-edit-new-edit-buffer (generate-new-buffer "comment-edit-new"))
       )
    ...
    ;;
    (with-current-buffer comment-edit-main-buffer
      (comment-edit-start-end-commented-line)
      )
    
    (with-current-buffer comment-edit-new-edit-buffer
    ...
    (with-current-buffer comment-edit-main-buffer 
      ...
      (insert-buffer-substring comment-edit-new-edit-buffer))
    (kill-buffer comment-edit-new-edit-buffer)) ;; let
  )
